                  ...
                  <table class='table'>
                    <tr>
                      ...
                      <td width="200px">
                        ...
                        <select class='form-select supplier-select' name='salesman' required>
                          <option value=''>Please select</option>";
                          <?php
                        ...
                        <tbody>
                          ...
                          if(METHOD == 'edit' && defined('ID')){
                            ...
                            foreach ($items as $item) {
                              ...
                              print "<td><input type='text' class='form-control' readonly value='$variance->particulars $variance->size X $variance->unit' ></td>";
                              print "<td><input type='number' class='form-control w100 qty' name='product[$id]' placeholder='Qty' value='$qty' ></td>";
                              print "<td><input type='number' class='form-control price' readonly placeholder='Price' value='$variance->price' ></td>";
                              print "<td class='total'>RM ".nf($variance->price * $qty)."</td>";
                              print "<td class='text-center'><i class='ti ti-trash f-20'></i></td>";
                              print "</tr>";
                              $total += $variance->price * $qty;
                              $i++;
                            }
                          } else{
                            foreach ($post->product as $id => $qty) {
                  ...
                  <div class="col-12">
                    <div class="invoice-total ms-auto">
                      <div class="row">
                        ...
                        <div class="col-6"> <p class="f-w-600 mb-1 text-start">Grand Total : <span class='grand-total'>RM <?php print nf($total); ?></span></p></div>
