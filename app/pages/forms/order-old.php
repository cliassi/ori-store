...
if(METHOD == 'collect'){
  ...
  if(isset($post->save)){
    ...
    foreach ($post->variance as $id => $qty) {
      ...
      if(isset($post->sst[$id])) {$ii->sst = $post->sst[$id];} else{$ii->sst = 0 ;}
            ...
            <?php endif; ?>
                  ...
                  <div class="col-12">
                    <div class="order-total ms-auto">
                      <div class="row">
                        <div class="col-10"> <p class="f-w-600 mb-1 text-start">Grand Total :</p></div>
                        <div class="col-2"> <p class="f-w-600 mb-1 grand-total">RM <?php print nf($total); ?></p></div>
                      </div>
                    </div>
                  </div>
                  <!-- <div class="col-12">
