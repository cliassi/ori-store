...
print "<thead>
	<th>Sl.</th><th>Name</th><th style='width: 50px;'>Entry</th><th>Username</th><th>PIN</th><th>Password</th><th>Notification</th><th>Roles</th><th>User Since</th><th>Status</th><th>Last IP</th><th>Last Login Time</th><th>" . options2('user', '', array('add')) . "</th>
	</thead>";
print "<tbody>";
$i = 1;
$owners[uid()] = username();
while ($user = mysqli_fetch_object($users)) {
	...
	if (file_exists("uploads/user/avatar/$user->u_avatar") && nn($user->u_avatar)) {
		$avatar = "<img src='" . BASEURL . APP . "/uploads/user/avatar/$user->u_avatar' class='w30'>";
	} else {
		$avatar = "";
	}
