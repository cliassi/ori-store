  ...
  <script type="text/javascript">
    ...
    function placeOrder(){
      ...
      $('.cart-item').each(function() {
              ...
              var quantity = $(this).val(); // Get the quantity from button text
    ...
    setTimeout(function(){
      $(".ol,.op").click(function(){
        const t = $(this).find('select');
        const op = $(this).find('select option:selected');
        console.log(op.text());
        let qty = parseInt(t.val());
        qty = qty+1;
        const sq = qty.toString();
        if(qty>10){
