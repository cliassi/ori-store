            ...
            <div class="card">
              <div class="card-body p-0">
                <ul class="nav nav-tabs checkout-tabs mb-0" id="myTab" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <a class="nav-link" id="ecomtab-tab-2" data-bs-toggle="tab" href="#ecomtab-2" role="tab" aria-controls="ecomtab-2" aria-selected="false" tabindex="-1">
                      <div class="d-flex align-items-center">
                        <div class="avtar avtar-s">
                  ...
                  <li class="nav-item" role="presentation">
                    <a class="nav-link" id="ecomtab-tab-3" data-bs-toggle="tab" href="#ecomtab-3" role="tab" aria-controls="ecomtab-3" aria-selected="false" tabindex="-1">
                      <div class="d-flex align-items-center">
                        <div class="avtar avtar-s">
              ...
              <div class="tab-pane show active" id="ecomtab-1" role="tabpanel" aria-labelledby="ecomtab-tab-1">
                <div class="row">
                  <div class="col-xl-8">
                          ...
                          <table class="table mb-0" id="pc-dt-simple">
                            ...
                            <tbody>
                              <tr>
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img src="../assets/images/application/img-prod-2.jpg" alt="image" class="bg-light wid-50 rounded">
                              ...
                              <tr>
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img src="../assets/images/application/img-prod-3.jpg" alt="image" class="bg-light wid-50 rounded">
                                    <div class="flex-grow-1 ms-3">
                                      <h5 class="mb-1">Apple MacBook Pro</h5>
                                      <p class="text-sm text-muted mb-0">Dark Red</p>
                                    </div>
                              ...
                              <tr>
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img src="../assets/images/application/img-prod-4.jpg" alt="image" class="bg-light wid-50 rounded">
                                    <div class="flex-grow-1 ms-3">
                                      <h5 class="mb-1">Apple MacBook Pro</h5>
                                      <p class="text-sm text-muted mb-0">Dark Red</p>
                                    </div>
                    ...
                    <div class="text-end">
                      <a href="../application/ecom_product.html" class="btn btn-link-secondary d-inline-flex align-items-center"><i class="ti ti-chevron-left me-2"></i> Back to Shopping</a>
                    </div>
                  </div>
                  <div class="col-xl-4">
                    <div class="card">
                          ...
                          <div class="row">
                            <div class="col-12">
                              ...
                              <div class="text-end btn-page mb-0 mt-4">
                                ...
                                <button class="btn btn-primary" onclick="change_tab('#ecomtab-3')">Save &amp; Deliver to this Address</button>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="card-body">
                          ...
                          <div class="row">
                            <div class="col-12 mt-2">
                              <div class="mb-3 row">
                                <label class="col-lg-4 col-form-label">Card Number :<small class="text-muted d-block">Enter the 16 digit card number on the card</small></label>
                                <div class="col-lg-8">
                                  <input type="text" class="form-control">
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label class="col-lg-4 col-form-label">Expiry Date :<small class="text-muted d-block">Enter the expiration on the card</small></label>
                                <div class="col-lg-8">
                                  <div class="row">
                                    <div class="col-6">
                              ...
                              <div class="mb-3 row">
                                <label class="col-lg-4 col-form-label">CVV Number :<small class="text-muted d-block">Enter the 3 or 4 digit number on the card</small></label>
                                <div class="col-lg-8">
                                  <input type="text" class="form-control">
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label class="col-lg-4 col-form-label">Password :<small class="text-muted d-block">Enter your dynamic password</small></label>
                                <div class="col-lg-8">
