...
<table class="table table-bordered">
  ...
  <?php
    ...
    if($_collection){
      $official_receipts = select("o.*, w.contact name, w.company, w.id wid", "collection o, customer w", "o.customer_id=w.id AND o.deleted_by IS NULL AND (o.date BETWEEN '$d' AND '$t')");
