<?php 
  ...
  $fields = [
    "id" => '',
    "company" => ["label"=>"Comapny Name", "display"=>'', 'link'=>'../../supplier/details'],
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col"><h5>Supplier Due Report</h5></div>
                    ...
                    if(isset($value['display'])) {
                      ...
                      if(isset($value['type'])){
                        if($value['type'] == "image") {
                          ...
                          // print "<td>".($obj->$key ? "<a data-lightbox='{$obj->$key}'><img src='/store/{$obj->$key}' width='120px'></a>" : "")."</td>";
                          $printed = true;
