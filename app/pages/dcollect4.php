...
<table class="table table-bordered table-hover table-striped table-customer">
    <thead>
        <tr>
            <th>
                <a href='' class='has-checkbox'><span><input type='checkbox' id='all-order' data-type='all'> Delivery</span></a>
...
$(document).on('click', 'button[name="deliver"]', function(e) {
    e.preventDefault();
    
    var form = $(this).closest('form');
    var formData = form.serialize() + '&deliver=deliver';  // Add deliver parameter
    
    console.log('Delivering...', formData);
    
    // Post to the correct endpoint
    $.post('/store/ajax/dcollect.php', formData)
