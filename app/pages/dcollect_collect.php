    ...
    if ($selectedCustomerIds) {
      ...
      $fallbackQuery = "SELECT ii.id
              ...
              WHERE i.customer_id IN ($customerIdsSql)
                ...
                AND (ii.assigned_at IS NOT NULL AND ii.assigned_to IS NOT NULL AND ii.assigned_to != '')";
...
<script type="text/javascript">
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    dateModal = bootstrap.Modal.getOrCreateInstance(document.getElementById('dateModal'));
  ...
  function triggerChange() {
    ...
    $.post('/store/ajax/dcollect_collect.php', {
