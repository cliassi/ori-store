...
if (isset($get->h)) {
	...
	while ($w = mysqli_fetch_object($workers)) {
		...
		print "</td>
					...
					<td>" . ($w->lock ? "" : "<input type='checkbox' class='worker-payment' data-name='$w->name' data-id='$w->id' data-balance='$bal_data'>") . "</td>
					<td>
...
/*
	...
	while ($hotel = mysqli_fetch_object($hotels)) {
		...
		print "<td class='text-center'>" . nf0($paid) . "</td>";
		sum("expense", $paid);
		print "<td class='text-center'>" . nf0($total_salary - $paid) . "</td>";
		sum("balance", $total_salary - $paid);
			...
			<form method="post" autocomplete="off" enctype='multipart/form-data'>
				...
				<div class="modal-body">
					<table class="table table-bordered">
						...
						<tr>
							<td>Name</td>
							<td><input type='text' class='form-control w300' required placeholder="Enter account name"
									id='account_name'>
						<tr>
							<td>Amount</td>
							<td>
							  ...
							  <tr>
								...
								<input type="number" name="amount" required id="payment_amount" readonly
									class="form-control payment_amount w100" placeholder="Amount">
								<!-- </td> -->
								<!-- <td></td>
								  <td> &nbsp;&nbsp;
