        ...
        <div class="page-block">
            <div class="row align-items-center">
                <div class="d-flex flex-wrap gap-2">
                    <div class="d-flex flex-wrap gap-2">
                        <button type="button" class="btn btn-shadow btn-primary">100 Plus</button>
                        <button type="button" class="btn btn-shadow btn-secondary">SeaMaster</button>
                        <button type="button" class="btn btn-shadow btn-success">Spritzer</button>
                        <button type="button" class="btn btn-shadow btn-danger">Red Bull</button>
                        <button type="button" class="btn btn-shadow btn-warning">Speed</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card product-card">
                      <div class="card-img-top">
                        <a href="application/ecom_product-details.html">
                          <img src="https://picsum.photos/400/400" alt="image" class="img-prod img-fluid" />
                        </a>
