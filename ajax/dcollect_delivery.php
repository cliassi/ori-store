      ...
      while ($i = mysqli_fetch_object($items)) {
        ...
        if ($i->quantity > 0) {
          ...
          if ($delivery) {
            ...
            print "</td><td class='text-center order-qty-col'><a href='#' id='invoice-item-$i->iid' data-bs-toggle='modal' onClick='setItemId($i->iid)' data-bs-target='#modal-modify-quantity'>$collected</a></td>";
          }
          print "</tr>";
          $ic++;
        }
