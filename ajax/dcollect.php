...
$collected = 0;
            ...
            print "</td><td class='text-center order-qty-col'>" . ($restrictedUser ? "<span>$collected</span>" : "<a data-id='$i->iid' id='invoice-item-$i->iid' href='#' data-bs-toggle='modal' onClick='setItemId($i->iid)' data-bs-target='#modal-modify-quantity'>$collected</a>") . "</td>";
            print "</tr>";
            $ic++;
          }
          $ci++;
