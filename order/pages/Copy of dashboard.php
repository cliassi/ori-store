        ...
        <div class="shortcut-table shadow-sm">
            <div class="shortcut-grid">
                ...
                $items = [
                    ...
                    ['label' => 'Order n Collect', 'icon' => 'view-list',       'page' => 'dcollect'],
                    // Row 2
                    ['label' => 'Expenses',        'icon' => 'receipt-tax',     'page' => 'expenses'],
                    ['label' => 'Daily Sales',     'icon' => 'chart-bar',       'page' => 'daily_sales'],
                    ['label' => 'Delivery Status', 'icon' => 'clipboard',       'page' => null],
                    ['label' => 'Delivery',        'icon' => 'delivery',         'page' => 'delivery'],
                    // Row 3
                    ['label' => 'CnR Report',      'icon' => 'clipboard-list',  'page' => 'cnr_report'],
                    ['label' => 'File Manager',    'icon' => 'credit-card',     'page' => null],
                    ['label' => 'Product +',       'icon' => 'plus-circle',     'page' => 'product_add'],
                    ['label' => 'Pen Order',       'icon' => 'clipboard',       'page' => 'pending_order'],
                    // Row 4
                    ['label' => 'Supplier',        'icon' => 'user-add',        'page' => 'supplier_add'],
                    ['label' => 'Sup Due',         'icon' => 'user-circle',     'page' => 'supplier_due'],
