...
<head>
    ...
    <title>A Pure Water - Customer Due</title>
...
<?php
// Business logic from due.php
$fields = [
    "id" => '',
    "code" => ["label"=>"Code", "display"=>''],
    "company" => ["label"=>"Company Name", "display"=>'', 'link'=>'../../customer/details'], 
...
<div class="bg-primary blob-shape text-white">
    <div class="max-w-sm mx-auto px-4 py-6">
        <h2 class="text-xl font-bold text-center mb-4">Customer Due Report</h2>
        <div class="relative">
            ...
            <table id="customer-table" class="w-full text-xs">
                ...
                <tbody>
                    ...
                    foreach ($objs as $key => $obj) {
                        ...
                        // Only show customers with due amounts
                        if($due_amount == 0) continue;
                        
                        echo "<tr class='border-b'>";
                        echo "<td class='px-2 py-1'>$obj->code</td>";
                        echo "<td class='px-2 py-1'><a href='../../customer/details/$obj->id' class='text-blue-600 font-medium'>$obj->company</a></td>";
