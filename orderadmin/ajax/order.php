    ...
    while ($customer = mysqli_fetch_object($customers)) {
      ...
      $con = "<div class='customer-item customer-$customer->id'>
        ...
        if (isset($customer->map) && !empty(trim($customer->map))) {
            ...
            $mapIcon = "<a href='" . htmlspecialchars($mapUrl, ENT_QUOTES, 'UTF-8') . "' target='_blank' rel='noopener' title='Open map' style='position:absolute;left: 42px;margin-top: -5px;'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' style='width:18px; height:18px;'><path fill='#E53935' d='M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z'/></svg></a>";
        }
