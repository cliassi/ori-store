...
?>
    ...
    <div class="text-center mb-3-3 position-relative" style="background: linear-gradient(135deg, #1e90ff 0%, #00bfff 100%); padding: 20px 15px; margin: -8px -8px 0px -8px; border-radius: 0 0 20px 20px; box-shadow: 0 4px 12px rgba(30, 144, 255, 0.3);">
      <h1 class="h3 mb-0" style="color: white; font-weight: 600; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">Collect</h1>
    ...
    justify-content: space-between;">
      ...
      <button id="btnCollect" class="btn btn-warning" type="submit" name="collect" value="1" form="dcollectForm" style="flex: 1; max-width: 110px; font-size:.75rem;">Collect</button>
    </div>
