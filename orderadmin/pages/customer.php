...
<body class="bg-gray-50 min-h-screen">
    ...
    if (!isUserIn(['parvez']) || $isDeliveryStaff) {
        ...
        <div class="max-w-sm mx-auto px-4 py-6">
            <div class="relative mb-4">
                <input type="text" id="search" placeholder="Search Customer"
                    class="w-full px-3 py-2 rounded text-gray-800 text-sm">
            </div>
    ...
    <div class="max-w-sm mx-auto px-4 -mt-6">
                ...
                <table id="customer-table" class="w-full text-xs">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-2 py-2 text-center"><a href="?page=customer_add"
                                    class="text-blue-600 font-medium">Add New</a></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
        ...
        <div class="mt-4 flex justify-center">
            <button onclick="openModal('addCustomerModal')" aria-label="Add Customer"
                class="bg-primary hover:bg-primaryDark text-white rounded-full p-3 shadow-lg focus:outline-none focus:ring-2 focus:ring-primaryDark">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                            onclick="closeModal('addCustomerModal')">Close</button>
