...
<div class="text-center mb-3 position-relative">
  <h1 class="h3 mb-0" style="color: #333; font-weight: 600;">Delivery Status</h1>
  <div style="position: absolute; top: 0; right: 15px;">
    <select id="delivery-staff-filter" class="form-select form-select-sm" style="min-width: 120px; font-size: 0.8rem;">
    ...
    <table class="table table-bordered table-hover table-striped table-customer w-100">
      <thead>
        <tr>
          ...
          <?php
          $areas = R::find('city', '1=1 ORDER BY name');
      ...
      <tbody>
        ...
        print "<label class='mb-1 d-block' style='cursor:pointer' onclick=\"$('#areas').toggle(); var open = $(this).data('open') === true; open = !open; $(this).data('open', open); $(this).find('.area-arrow').text(open ? 'expand_less' : 'expand_more');\">Select Area(s) <span class='material-icons area-arrow' style='vertical-align:middle;font-size:18px'>expand_more</span></label>";
        print "<select id='areas' multiple class='form-select' size='8' style='display:none;min-width:220px'>";
